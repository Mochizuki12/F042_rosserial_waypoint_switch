#ifndef _ROS_ros_mypkg_msgs_Custom_h
#define _ROS_ros_mypkg_msgs_Custom_h
...
namespace ros_mypkg_msgs
{
  ...
  class Custom : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "ros_mypkg_msgs/Custom"; };
    virtual const char * getMD5() override { return "f9d86ff4272085f66f41cd72b9cfc49d"; };
